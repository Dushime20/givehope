...
const Footer = () => {
  return (
    <footer className="bg-[#404040] text-white py-16">
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                ...
                <div>
                  ...
                  <Link to="#" className="text-blue-400 hover:text-blue-300">Read More</Link>
                </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-medium mb-1">
                          <Link to="/blog-single" className="hover:text-blue-400">
                ...
                <div>
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-center gap-3">
                      ...
                      <a href="tel:+23923929210" className="text-gray-400 hover:text-blue-400">+2 392 3929 210</a>
                    </li>
                    <li className="flex items-center gap-3">
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      <a href="mailto:info@yourdomain.com" className="text-gray-400 hover:text-blue-400">info@yourdomain.com</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="text-center text-gray-400 pt-8 border-t border-gray-800">
                <p>
                  ...
                  <a href="https://colorlib.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">
                    Colorlib
                  </a>
                </p>
              </div>
