...
import { ArrowLeft, Heart, Share2, Bookmark, ArrowRight } from "lucide-react";
              ...
              <div className="space-y-4">
                ...
                {project.raisedFund > 0 && (
                  <div className="flex justify-between py-2">
                    ...
                    <span className="font-medium">
                      {formatCurrency(project.raisedFund)}
                    </span>
                  </div>
                )}
              </div>
                  ...
                  allProjects
                    ...
                    .map((proj) => (
                      <li key={proj.id}>
                        <Link
                          to={`/project/${proj.id}`}
                          className={`flex items-center justify-between px-4 py-3 rounded-lg border border-gray-200 bg-gray-50 hover:bg-blue-100 hover:text-blue-700 active:bg-blue-200 transition-all duration-200 shadow-sm hover:shadow-md ${
                            proj.id === project.id
                        ...
                        >
                          ...
                          <span className="text-gray-400 group-hover:text-blue-700">
